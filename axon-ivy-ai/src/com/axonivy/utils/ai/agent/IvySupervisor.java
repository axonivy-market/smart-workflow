...
public class IvySupervisor {
  private OpenAiChatModel model;
  private AgentChatMemoryProvider memoryProvider;
  private String memoryId;
  private IvySubProcessToolsProvider toolProvider;

  public IvySupervisor(OpenAiChatModel model, AgentChatMemoryProvider memoryProvider, String memoryId,
  ...
  public IvySupervisor(AgentChatMemoryProvider memoryProvider, String memoryId,
      IvySubProcessToolsProvider toolProvider) {
    buildDefaultModel();
    this.memoryProvider = memoryProvider;
    this.memoryId = memoryId;
