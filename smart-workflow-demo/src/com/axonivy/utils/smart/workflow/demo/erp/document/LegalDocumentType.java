...
public enum LegalDocumentType {
   ...
   * Use this where a {@code null} result needs to be handled distinctly.
   */
   ...
   * Cert-specific patterns (9001, 14001, 27001, gdpr/dpa) are checked before
   * the generic "cert"/"iso" fallback so that specific sub-types take priority.
   */
