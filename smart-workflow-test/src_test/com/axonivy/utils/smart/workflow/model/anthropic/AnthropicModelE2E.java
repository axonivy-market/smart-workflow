...
class AnthropicModelE2E {
  ...
  void setup(AppFixture fixture) {
    fixture.var(AiConf.DEFAULT_PROVIDER, AnthropicModelProvider.NAME); // enforce Anthropic!
    fixture.var(AnthropicConf.API_KEY, TestUtils.getSystemProperty("ANTHROPIC_API_KEY"));
  }
  ...
  static boolean providerSelected() {
    return TestUtils.isProviderEnabled(AnthropicModelProvider.NAME);
  }
